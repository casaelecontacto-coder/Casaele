...
const Courses = () => {
  ...
  const [uploadingEmbedHtml, setUploadingEmbedHtml] = useState(null); // index of embed being uploaded
  ...
  const handleEmbedHtmlUpload = async (index, file) => {
    ...
    try {
      ...
      updateCourseEmbed(index, 'embedCode', result.url);
      updateCourseEmbed(index, 'type', 'HTML');
    } catch (e) {
